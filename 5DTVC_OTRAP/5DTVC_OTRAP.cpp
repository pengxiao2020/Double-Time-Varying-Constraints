...
void SaveResult()
{
	...
	// 保存算法 OTRAP 的求解结果
	string OTRAP_SolutionFile = "../data/ExperimentalResults/exp2/5DTVC_OTRAP/data_CarInfo_20%_8000_2000/5DTVC_OTRAP_Solution_CarInfo_" + to_string(RS_S_CarNum) + "_" + to_string(RS_L_CarNum) + "-" + to_string(ExeNum) + ".txt";

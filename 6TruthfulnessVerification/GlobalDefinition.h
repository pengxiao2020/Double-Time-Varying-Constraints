...
#define S_EcsNum 0		//小型基站数
#define L_EcsNum 8		//大型基站数
...
// 3.车辆信息相关
#define RS_S_CarNum 10000		//读入的已经随机抽取的小型车辆任务数		
...
int ExeNum = 4;						//第几次运行 DTVC_OTRAP 机制，初始值为 1

//exp 4 相关
#define win_car_id 6823
#define win_car_bid 800		//400, 450, 500, 550, 600, 650, 700, 750, 800
#define lose_car_id 7703
#define lose_car_bid 950	//600, 650, 700, 750, 800, 850, 900, 950

//基站的 基本信息 和 资源容量矩阵 分开保存
#define EcsInfoFile "../data/2RandomSampling/exp4/data_EcsInfo_" + to_string(S_EcsNum) + "_" + to_string(L_EcsNum)+ ".txt"
#define EcsInfoFile_RCM "../data/2RandomSampling/exp4/data_Ecs_RCM_" + to_string(S_EcsNum) + "_" + to_string(L_EcsNum)+ ".txt"
...
#define RS_CarInfoFile_S "../data/2RandomSampling/exp4/data_RS_CarInfo_S_"+ to_string(RS_S_CarNum) + "-" + to_string(ExeNum) + "_" + to_string(lose_car_id) + "(" + to_string(lose_car_bid)+ ").txt"		//小型车辆任务信息
#define RS_CarInfoFile_S_RDM "../data/2RandomSampling/exp4/data_RS_Car_RDM_S_"+ to_string(RS_S_CarNum) + "-" + to_string(ExeNum) + ".txt"	//小型车辆的资源需求矩阵
#define RS_CarInfoFile_S_DCM "../data/2RandomSampling/exp4/data_RS_Car_DCM_S_"+ to_string(RS_S_CarNum) + "-" + to_string(ExeNum) + ".txt"	//小型车辆的部署约束矩阵
